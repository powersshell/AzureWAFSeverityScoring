...
foreach ($file in $response) {
    if ($file.type -eq "file") {
        ...
        # Write-Output "Processing File/RulesList from:" $file.download_url
...
Write-Output "Uploading Results to: " $uri 
$uploadResponse = Invoke-RestMethod -Uri $uri -Method "Post" -Body $JSONUpload -Headers $headers -ErrorAction Stop
